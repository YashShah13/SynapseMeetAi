...
export const AgentIdView = ({ agentId }: Props) => {
  ...
  const removeAgent = useMutation(
    ...
    `This action will permanently remove ${data.meetingCount} associated ${
      ...
      <div className="flex-1 py-4 px-4 md:px-8 flex flex-col gap-y-4">
        ...
        <div className="bg-white rounded-lg border shadow-sm">
          <div className="px-6 py-5 flex flex-col gap-y-5">
            ...
            <Badge
              variant="outline"
              className="flex items-center gap-x-2 text-sm text-gray-700 border-gray-300"
            >
            ...
            <div className="flex flex-col gap-y-2">
              <p className="text-lg font-medium text-gray-800">instructions</p>
